...
heroes.forEach( (arbitraryNameForEachElementOfArray) => {
    ...
    // within a function but from the global scope -> callbacks are passed as parameters
})
...
const chainedArray = newArray
                    ...
                    .filter( (num) => num >=40 ) // value from last function will be returned
