...
console.table([Math.abs(-9), Math.round(4.6), Math.round(7.5), Math.ceil(8.1), Math.floor(6.8)])
...
// The question is, What if we add it at the end -> It will give a result of[min+1, max+1]
