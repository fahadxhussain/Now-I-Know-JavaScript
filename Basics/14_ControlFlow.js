...
switch(month){
    ...
    case 3:
        console.log("March") // once a case is matched, none of the cases below it are compared
...
val1 = 5 ?? 10
console.log(val1)
val1 = null ?? 10 // 10 is simple here but usually there are complec functions
console.log(val1)
